package com.wiedenman.foundry_0_1.config;

import com.wiedenman.foundry_0_1.service.UserService;
import com.wiedenman.foundry_0_1.web.FlashMessage;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AuthenticationSuccessHandler loginSuccessHandler() {
        ...
        return (request, response, authentication) -> response.sendRedirect("/page/index");
    }
